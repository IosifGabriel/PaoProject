...
class SucursaleDelete extends JPanel implements ActionListener
{
    JTextArea taArea0;
    JButton btFInd;
    JButton btBut1;

    public SucursaleDelete()
    {
        super();
    ...
    public void actionPerformed( ActionEvent e )
    {
        if ( e.getSource() == btFInd )
        {
            ...
            CladiriDBService.getInstance().deleteSucursala(i);
            showMessageDialog(null,  "Sucursala stearsa");
        }
