...
class OraseFind extends JPanel implements ActionListener
{
    JTextArea taArea0;
    JButton btFInd;
    JButton btBut1;
    ...
    public void actionPerformed( ActionEvent e )
    {
        if ( e.getSource() == btFInd )
        {
            ...
            Oras oras = OrasDBService.getInstance().findOras(i);
            showMessageDialog(null,  oras.getNume() + " " + oras.getTara());
        }
